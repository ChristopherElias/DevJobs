<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <select wire:model="salario" id="salario" 
                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focis:ring-indigo-200 focus:ring-opacity-50 w-full">
    ...
    <div>
        ...
        <x-text-input id="empresa" 
                        ...
                        placeholder="Empresa: ej. Netflix, Google, etc." />
    ...
    <div>
        ...
        <textarea wire:model="descripcion" id="descripcion"
                    ...
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focis:ring-indigo-200 focus:ring-opacity-50 w-full h-72" >
        </textarea>
